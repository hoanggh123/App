...
('yta01',N'Phạm Quang Huy',1,'1998-03-01',N'Đường Giải Phóng, Phường Tân Lợi, Thành phố Buôn Ma Thuật, Đắk LắK',N'huy98@gmail.com','064123248734',N'Khoa Nhi',N'Y tá',N'Đại học','huy.png','2020-12-03','K4','0909331232','P028'), 
('bsi05',N'Nguyễn Văn Hà',1,'1998-01-09',N'Xuân Phong, Xã Hợp Phong, Huyện Cao Phong, Hòa Bình',N'nguyenha12@gmail.com','053091038491',N'Khoa Nhi',N'Bác sĩ',N'Đại học','ha.png','2020-03-12','K4','0904071234','P028'),
('bsi02',N'Chu Văn Thái Sơn',1,'1978-12-12',N'Văn Nhuệ, Ân Thi - Hưng Yên',N'thaison12@gmail.com','084357821234',N'Khoa Nội',N'Bác sĩ',N'Đại học','son.png','2018-01-09','K1','0908765437','P012'),
('yta11',N'Lê Thị Quỳnh Nhi',0,'1987-02-18',N'Phường 24, Quận Bình Thạnh, TP.HCM',N'quynhnhi@gmail.com','093647346747',N'Khoa Nội',N'Y tá',N'Cao đẳng','nhi.png','2020-03-12','K1','0355204677','P012'),
('bsi03',N'Hoàng Trung Hiếu',1,'1978-12-12',N'Xã Đức Hòa Đông, Huyện Đức Hòa,Long An',N'trunghieu02@gmail.com','077523901123',N'Khoa Nội soi',N'Bác sĩ',N'Cử nhân khoa học y tế','hieu.png','2019-12-03','K8','0932012782','P022'),
('yta12',N'Nguyễn Phạm Mai Quỳnh',0,'1999-03-12',N'885 Trường Chinh, P.Tây Thạnh, Q.Tân Phú',N'maiquynh@gmail.com','064125367562',N'Khoa Nội soi',N'Y tá',N'Đại học','quynh.png','2018-03-18','K8','0923674674','P022'),
('bsi04',N'Lê Văn Quân',1,'1968-10-03',N'Vàm Bi, Xã Trường Long, Huyện Phong Điền, Cần Thơ',N'lequan12@gmail.com','064127437289',N'Khoa Dược',N'Bác sĩ',N'Đại học','quan.png','2020-03-12','K9','0977128239','P025'),
('yta07',N'Trần Anh Lực',1,'1977-02-07',N'Phường Phước Ninh, Quận Hải Châu',N'tranluc02@gmail.com','026423784726',N'Khoa Dược',N'Y tá',N'Đại học','luc.png','2020-07-12','K9','0905731835','P025'),
('yta06',N'Nguyễn Thị Thu Hiền',0,'2001-01-09',N'43 đường  Nguyễn Chí Diểu, Phường An Hải Bắc, Quận Sơn Trà, Đà Nẵng',N'thuhien02@gmail.com','091023462374',N'Khoa xét nghiệm',N'Y tá',N'Cao Đẳng','hien.png','2019-07-19','K7','0977108583','P033'),
('bsi08',N'Ngô Ngọc Huy',1,'1998-01-09',N'Phường Thạc Gián, Quận Thanh Khê, Đà nẵng',N'ngochuy3@gmail.com','012734623746',N'Khoa xét nghiệm',N'Bác sĩ',N'Đại học','huy.png','2020-12-23','K7','0346790933','P033'),
('bsi09',N'Nguyễn Thị Minh Tâm',0,'1973-03-12',N'74 Lý Tế Xuyên, Linh Đông,Thủ Đức',N'minhtam@gmail.com','064126346736',N'Khoa Phụ sản',N'Bác sĩ',N'Đại học','tam.png','2018-01-17','K3','0926347894','P011'),
('yta10',N'Nguyễn Thị Hồng',0,'1978-01-02',N'Phường 10, Quận Gò Vấp, Tp.HCM',N'hong@gmail.com','084378467432',N'Khoa Phụ sản',N'Y tá',N'Đại học','hong.png','2020-02-11','K3','0356488345','P011'),
('bsi13',N'Nguyễn Hồng Hội',1,'1988-03-09',N'Bùi Đinh Túy, P21, Q.Bình Thạnh',N'honghoi@gmail.com','028367461783',N'Khoa Ngoại',N'Bác sĩ',N'Đại học','hoi.png','2019-03-12','K2','0783745628','P021'),
('yta14',N'Lý Thị Hồng Vân',0,'1998-01-09',N'940 Lạc Long Quân, Phường 8, Tân Bình',N'hongvan@gmail.com','053091038491',N'Khoa Ngoại',N'Y tá',N'Đại học','van.png','2017-07-12','K2','0364782356','P021'),
('bsi15',N'Nguyễn Thị Tuyết Nhi',0,'1999-07-23',N'Đường Phú Nhuận, Quận 7',N'tuyetnnhi@gmail.com','074674675789',N'Khoa Truyền Nhiễm',N'Bác sĩ',N'Đại học','tuyetnhi.png','2020-03-12','K5','0784673674','P030'),
('yta16',N'Trần Thị Thu Hiền',0,'1987-08-12',N'Phường long Thạnh, Thị xã Tân Châu, An Giang',N'thuhien02@gmail.com','064236748934',N'Khoa Truyền Nhiễm',N'Y tá',N'Đại học','thuhien.png','2015-10-01','K5','0374567239','P030'),
('bsi17',N'Bùi Công Tháp',1,'2001-03-22',N'Phường Kim Liên',N'congthap@gmail.com','0678956453',N'Khoa xét nghiệm',N'Bác sĩ',N'Cao Đẳng','thap.png','2021-01-27','K7','0456734334','P032'),
('bsi18',N'Phạm Công Nguyên',1,'1975-07-30',N'Phường Tân Phong, Quân 7',N'congnguyen@gmail.com','093456797812',N'Khoa Dinh Dưỡng',N'Bác sĩ',N'Tiến sĩ y khoa','nguyen.png','2020-03-12','K10','0983678400','P017'),
('yta19',N'Đinh Thị Nga',0,'1999-06-12',N'Phường 10,Quận 11, Tp.HCM',N'nga@gmail.com','046736456789',N'Khoa Dinh dưỡng',N'Y tá',N'Đại học','nga.png','2020-03-12','K10','0978256378','P017'),
('bsi20',N'Đinh Thị Thùy Dương',0,'1999-06-25',N'Phường Dịch Vọng, Quận Cầu Giấy',N'thuyduong05@gmail.com','034782356378',N'Khoa Chuẩn đoán hình ảnh',N'Bác sĩ',N'Cử nhân','duong.png','2020-03-12','K6','0937846746','P031'),
('yta21',N'Ngô Thị Điểm',0,'1968-06-12',N'Đường Huỳnh Tấn Phát, Phường Bình Thuận Quận 7, TP.HCM',N'diem06@gmail.com','096797834673',N'Khoa Chuẩn đoán hình ảnh',N'Y tá',N'Đại học','diem.png','2020-03-12','K6','0346783712','P031')
...
('BN13',N'Ngô Thị Chung',0,N'Ân Thi - Hưng Yên','034512891205','1986-12-04','0989687122',N'CKhông',N'Nông dân',N'Kinh',N'Dấu hiệu bệnh quai bị','2022-03-28','','0784673674'),
...
GO 
DROP TRIGGER IF EXISTS TR_UPDATE_CALEANDY
GO
CREATE TRIGGER TR_UPDATE_CALEANDY
ON LICHKHAM
FOR UPDATE
AS
BEGIN
	IF(UPDATE(MaLichKham))
	BEGIN
		PRINT (N'Mã Lịch khám  không được cập nhật')
	RETURN
	END
END
SELECT*FROM LICHKHAM
UPDATE LICHKHAM SET MaLichKham ='LK0017' WHERE  MaNV = 'bsi15'
...
delete from THUOC WHERE MaThuoc = 'TH21'
 ...
 -- UPDATE THUOC
 GO 
DROP TRIGGER IF EXISTS TR_UPDATE_PRYMACICY
GO
CREATE TRIGGER TR_UPDATE_PRYMACICY
ON THUOC
FOR UPDATE
AS
BEGIN
	IF(UPDATE(MaThuoc))
	BEGIN
		RAISERROR (N'Mã thuốc  không được cập nhật',16,1)
	RETURN
	END
END
SELECT*FROM THUOC

UPDATE THUOC SET MaThuoc =N'TH022' WHERE  MaNV ='yta14'
update THUOC SET TenThuoc ='HUYEN' WHERE MaThuoc = 'TH020'
-- DELETE THUOC
go
...
-- XÓA THIẾT BỊ
 ...
 -- UPDATE THIETBI
 GO 
DROP TRIGGER IF EXISTS TR_UPDATE_DEVICE
GO
CREATE TRIGGER TR_UPDATE_DEVICE
ON THIETBI
FOR UPDATE
AS
BEGIN
	IF(UPDATE(MaTB))
	BEGIN
		RAISERROR (N'Mã thiết bị  không được cập nhật',16,1)
	RETURN
	END
END
SELECT*FROM THIETBI

UPDATE THIETBI SET TenTB =N'Máy kiểm tra tim' WHERE  MaTB = 'TB30'
...
BEGIN
	IF(UPDATE(MaNV))
	BEGIN
		RAISERROR ('Mã Nhân viên không được cập nhật',16,1)
	RETURN
	END
END
SELECT*FROM NHANVIEN
select *from PHONG
UPDATE NHANVIEN SET MaPhong ='P022' WHERE  MaNV = 'bsi02'
...
-- UPDATe PHONG
GO 
DROP TRIGGER IF EXISTS TR_UPDATE_ROOM
GO
...
go
insert into BENHNHAN values
('BN54',N'Cục sạc bị hỏng',1,N'Chưprông - Gia Lai','027812342','2003-09-10''0465731284',N'Có',N'Sinh viên',N'Tày',N'Đau bụng phải','2022-09-12','sac.png','0981402640')
insert into BENHNHAN values
('BN67',N'Lương Thị Huế',1,N'Chưprông - Gia Lai','027812342318','2003-09-28','0465731274',N'Có',N'Sinh viên',N'Tày',N'Đau bụng phải','2021-09-12','hue.png','0981402640')
go
select * from benhnhan
-- delete
